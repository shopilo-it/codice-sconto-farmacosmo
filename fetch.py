#!/usr/bin/env python3
"""
Recupero codici sconto Farmacosmo da shopilo.it
Sursa: https://shopilo.it/negozi/farmacosmo.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/farmacosmo.it"
STORE_NAME = "Farmacosmo"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Farmacosmo da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-farmacosmo)"
    }
    try:
